...
public class ForySessionSerializerTest {
    ...
    public void testSerializeSessionObject() throws SessionSerializerException {
        ...
        ForySessionSerializer forySessionSerializer = new ForySessionSerializer();
        InputStream serialized = forySessionSerializer.serializeSessionObject(employee);
        Object deserialized = forySessionSerializer.deSerializeSessionObject(serialized);
